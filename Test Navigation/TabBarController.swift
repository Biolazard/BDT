...
class TabBarController: UITabBarController
{
    ...
    override func viewDidLoad() {
        ...
        viewControllers = [createTab(viewController: guadagnaController(), name: "Guadagna", image: UIImage(named: "search")), createTab(viewController: spendiController(), name: "Spendi", image: UIImage(named: "service")), createTab(viewController: profileController(), name: "Profilo", image: UIImage(named: "user"))]
